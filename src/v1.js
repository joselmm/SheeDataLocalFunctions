		...
		async function getSheetColumnsData(URL_API, SheetName, Columns, SaveAs, callBack){
		...
		async function selectRows(URL_API, TABLENAME, Objects_Array, WHERE, SaveAs, callBack){
		...
		async function updateRows(URL_API, TABLENAME, Objects_Array, WHERE, SaveAs, callBack){
		...
		async function deleteRows(URL_API, TABLENAME, Objects_Array, WHERE, SaveAs, callBack){
